...
export default class Show extends Component {
    ...
    render() {
        ...
        const { isDuplicate } = this.context;
            ...
            <div className={s.show}>
                ...
                <div className={s.content}>
                    ...
                    <Consumer>
                        {
                            ({setCart, isDuplicate}) => {
                                this.props.flag ? isDuplicate = false : isDuplicate = true;
                                this.props.flag = false;
                                return <button type="button" onClick={() => setCart(id)} disabled={isDuplicate}>Buy</button>
                            }
                        }
                    </Consumer>
